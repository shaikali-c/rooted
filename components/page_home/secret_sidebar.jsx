...
export default function SecretSidebar({ secrets }) {
  ...
  return (
    <div
      className={`md:px-3 px-4.5 md:pr-5 flex flex-col gap-5 h-dvh no-scrollbar md:max-h-dvh overflow-y-auto md:pt-15 pt-10 mask-[linear-gradient(to_bottom,#f8f8f8_70%,transparent_100%)] md:pb-55 pb-0 left-0`}
    >
